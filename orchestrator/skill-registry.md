...
| 评价设计skills | 设计分层评价任务 | 分层学习目标、评价模式、教材-练习册资源盘点 | 分层评价任务 + 成功标准 | 学习目标skills, 双资源调度策略 | 评价validators | active | v1.1 |
...
| 教学设计skills | 生成传统正文 + 后台折叠结构的课时方案 | 目标、评价、活动、课型结构、教材-练习册资源盘点 | 传统教学设计正文 + 完整结构化设计 | 学习目标skills, 评价设计skills, 活动设计skills, 双资源调度策略 | 教学设计validators | active | v1.2 |
| 协作式教学设计skills | 通过确认门编排传统正文 + 后台折叠结构教学设计 | 教材、课标、学情、教师逐门确认、教材-练习册资源盘点 | 传统教学设计正文 + 完整结构化设计 | 教学设计skills, 提问质量skills, 双资源调度策略 | 教学设计validators | active | v1.2 |

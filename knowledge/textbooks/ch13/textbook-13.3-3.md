...
可以这样验证：将 $\triangle ABC$ 叠放在 $\triangle A'B'C'$ 上，使边 $BC$ 落在边 $B'C'$ 上，顶点 $A$ 与顶点 $A'$ 在边 $B'C'$ 的同侧．由 $BC=B'C'$ ，可得边 $BC$ 与边 $B'C'$ 完全重合．因为 $\angle B=\angle B'$ ， $\angle C=\angle C'$ ， $\angle B$ 的另一边 $BA$ 落在边 $B'A'$ 上， $\angle C$ 的另一边 $CA$ 落在边 $C'A'$ 上，所以 $\angle B$ 与 $\angle B'$ 完全重合， $\angle C$ 与 $\angle C'$ 完全重合．由于“两条直线相交只有一个交点”，所以点 $A$ 与点 $A'$ 重合． 

所以， $\triangle ABC$ 和 $\triangle A'B'C'$ 全等. 
...
已知：如图13.3-9，在 $\triangle ABC$ 和 $\triangle A'B'C'$ 中， $\angle A = \angle A'$ ， $\angle B = \angle B'$ ， $BC = B'C'$ . 
...
证明：∵ $\angle A + \angle B + \angle C = 180^{\circ}$ ， $\angle A' + \angle B' + \angle C' = 180^{\circ}$ ，（三角形内角和定理）

又∵ $\angle A = \angle A'$ ， $\angle B = \angle B'$ ，（已知）

∴ $\angle C = \angle C'$ （等量代换）.

在△ABC 和△A'B'C' 中，

∵ $\left\{\begin{aligned}\angle B &= \angle B', \\ BC &= B'C', \\ \angle C &= \angle C'\end{aligned}\right.$ ∴ $\triangle ABC \cong \triangle A'B'C'$ (ASA). 
...
2. 已知：如图， $AB$ ， $CD$ 相交于点 $E$ ， $EC = ED$ ， $\angle C = \angle D$ ．求证： $\triangle AEC \cong \triangle BED$ 

## 习题

## A 组

1. 下面的三个命题都是假命题，请举反例说明. 
...
4. 已知：如图， $AB \perp AD$ ， $AC \perp AE$ ，AB = AD， $\angle B = \angle D$ 。求证：BC = DE。 
